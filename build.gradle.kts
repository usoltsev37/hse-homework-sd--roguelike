...
application {
    mainClass.set("GTAVIKt")
}

tasks.register<Jar>("gta-vi") {
    dependsOn("build")
    archiveBaseName.set("gta-vi")
    archiveVersion.set("")

    manifest {
        attributes["Implementation-Title"] = "GtaVI"
        attributes["Main-Class"] = "ru.hse.roguelike.GTAVIKt"
    }
